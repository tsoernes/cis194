...
/* package W5-0.1.0.0 */
#define VERSION_W5 "0.1.0.0"
#define MIN_VERSION_W5(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "W5-0.1.0.0-C1YhGcVwRjoCzSJResfj0m"

#define CURRENT_PACKAGE_KEY "W5-0.1.0.0-C1YhGcVwRjoCzSJResfj0m"
